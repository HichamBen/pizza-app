...
import { getRestaurants, HoldSuggestionsRestaurants } from "../reduxjs/reducers/suggestionsSlice";
...
export default function HomeS() {
    ...
    const restaurants = useSelector(state => state.restaurants.restaurantsRendered);
    ...
    useEffect(() => {
        ...
        if ([...searchParms].length === 0 || (!searchParms.get("restaurant") && searchParms.get("range") === "200" && searchParms.get("rating") === "0")) {
    ...
    return <>
        ...
        <div className="restaurant text-center mx-auto my-5">
            <h2><img src="/imgs/dish.png" alt="dish-icon"></img> Restaurants</h2>
        </div>
        ...
        <div className="row px-3 g-0 justify-content-center mt-5">
            ...
            <div className="col-12 col-sm-8 col-lg-9 d-flex flex-wrap mt-4 m-sm-auto align-items-center justify-content-center">
                {restaurants.length > 0 ? restaurants.filter((element, id) => {
                    if ((id + 1) > (page - 1) * 6) {
                        if ((id + 1) <= page * 6) {
                            return element;
                        }
                    ...
                    .map((element) => <Card key={element._id}
                        id={element._id}
